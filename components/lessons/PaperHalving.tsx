...
const MILESTONES: Milestone[] = [
  ...
  { step: 3,  label: "THUMBNAIL",        size: "26 mm",     note: "About the width of your thumbnail. Still paper.",                                                                                                                   image: "/milestones/thumb_nail.webp",    imageAlt: "Human thumbnail" },
  ...
  { step: 18, label: "VIRUS",            size: "800 nm",    note: "Approaching virus scale. Still paper.",                                                                                                                            image: "/milestones/virus.webp",         imageAlt: "Virus particle" },
  { step: 21, label: "LARGE PROTEIN",    size: "100 nm",    note: "The scale of a large protein molecule. Still paper.",                                                                                                              image: "/milestones/protien.webp",       imageAlt: "Protein molecule" },
  { step: 24, label: "DNA STRAND",       size: "12.5 nm",   note: "About the width of a DNA double helix. Still paper.",                                                                                                              image: "/milestones/dna.webp",           imageAlt: "DNA double helix" },
  { step: 27, label: "ETHANE MOLECULE",  size: "1.6 nm",    note: "Just a few atoms wide — an ethane molecule (C₂H₆). Two carbon atoms bonded together, each surrounded by three hydrogens. Still paper, but barely.",               molecule: "ethane" },
